<div class="page-header">
	<div class="pull-right">
		<button onclick="javascript:location.href='<?php echo base_url(); ?>/vistas/crear/'" type="button" class="btn btn-primary">Agregar</button>
	</div>
	<h1>Vistas</h1>
	<div class="row filtro">
		<form role="form" action="<?php echo base_url(); ?>/vistas/" method="get">
			<div class="col-lg-4">
		...
		<tbody>
			<?php if($vistas){ ?>
				<?php foreach($vistas as $aux){ ?>
					<tr>
						<td><a href="<?php echo base_url(); ?>/vistas/ver/<?php echo $aux->codigo; ?>/"><?php echo $aux->nombre; ?></a></td>
						<td class="editar">
							<a href="<?php echo base_url(); ?>/vistas/ver/<?php echo $aux->codigo; ?>/"><button title="Editar" type="button" class="btn btn-success btn-sm"><i class="icon-search"></i></button></a>
