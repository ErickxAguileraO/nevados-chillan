<div class="page-header">
	<div class="pull-right">
		<button onclick="javascript:location.href='<?php echo base_url(); ?>/tablas/crear/'" type="button" class="btn btn-primary">Agregar</button>
	</div>
	<h1>Tablas</h1>
	<div class="row filtro">
		<form role="form" action="<?php echo base_url(); ?>/tablas/" method="get">
			<div class="col-lg-4">
		...
		<tbody>
			<?php if($tablas){ ?>
				<?php foreach($tablas as $aux){ ?>
					<tr>
						<td title="<?php echo $aux->comentario; ?>"><a href="<?php echo base_url(); ?>/tablas/editar/<?php echo $aux->codigo; ?>/"><?php echo $aux->nombre; ?></a></td>
						<td class="editar">
							<a href="<?php echo base_url(); ?>/tablas/editar/<?php echo $aux->codigo; ?>/"><button title="Editar" type="button" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a>
