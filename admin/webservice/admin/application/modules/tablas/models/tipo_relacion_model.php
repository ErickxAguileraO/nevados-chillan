...
class Tipo_relacion_model extends CI_Model {
    
    private $tabla = 's_tipos_relacion';
    ...
    public function obtener_por_codigo($codigo){
        return $this->obtener(array('tipr_codigo'=>$codigo));
	}
	...
	public function obtener($where){
		...
		if($aux){
            $obj = new stdClass();
			$obj->codigo = $aux->tipr_codigo;
			$obj->nombre = $aux->tipr_nombre;
