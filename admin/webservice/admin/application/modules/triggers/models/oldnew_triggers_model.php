...
class Oldnew_triggers_model extends CI_Model {
    
    private $tabla = 's_oldnew_triggers';
    function __construct(){
        parent::__construct();
    }

    public function obtener_por_codigo($codigo){
        return $this->obtener(array('olne_codigo'=>$codigo));
	}
	...
	public function obtener($where){
		...
		if($aux){
            $obj = new stdClass();
			$obj->codigo = $aux->olne_codigo;
			$obj->nombre = $aux->olne_nombre;
