...
class Secciones extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/bike-park/secciones/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/bike-park/secciones/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "secc_tipo_seccion = 11";
        $and = " and ";
		...
		$config['base_url'] = '/bike-park/secciones/';
		$config['per_page'] = 20;
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
           ...
           /* if($this->input->post('ruta_interna_2'))
            ...
            #registro
            if($contenido['seccion'] = $seccion = $this->ws->obtener($this->modulo,"secc_codigo = '$codigo' and secc_tipo_seccion = 11"));
            else show_error('');
