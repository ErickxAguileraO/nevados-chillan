...
class Slider extends CI_Controller {
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/bike-park/slider/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "sli_tipo_seccion = 10";
        $and = " and ";
		...
		$config['base_url'] = '/bike-park/slider/';
		$config['per_page'] = 20;
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['sli_tipo_seccion'] = 10; #indica que pertenece a bike-park
            ...
            #js
            $this->layout->js('/js/sistema/bike-park/slider/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/bike-park/slider/', "Agregar slider" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['slider'] = $slider = $this->ws->obtener($this->modulo,"sli_codigo = '$codigo' and sli_tipo_seccion = 10"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/bike-park/slider/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/bike-park/slider/', "Editar slider" => "/"));
