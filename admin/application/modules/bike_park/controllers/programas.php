...
class programas extends CI_Controller {
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/bike-park/programas/index.js');
		...
		$config['base_url'] = '/bike-park/programas/';
		$config['per_page'] = 20;
		$config['total_rows'] = count($this->ws->listar($this->modulo,"prog_tipo = 'bike-park'"));
        $config['suffix'] = '/'.$url;
        ...
        $contenido["programas"] = $this->ws->listar($this->modulo,"prog_tipo = 'bike-park'");
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/bike-park/programas/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Programas" => '/bike-park/programas/', "Agregar programas" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/bike-park/programas/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("programas" => '/bike-park/', "Editar Sección" => "/"));
