        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/zona-debutantes/secciones/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/zona-debutantes/secciones/eliminar_imagen/';
    var urlCargar = '/zona-debutantes/secciones/cargar_imagen/';
    var urlCortar = '/zona-debutantes/secciones/cortar_imagen/';
    var galeria = false;
    var cargar = [];
    <?php if(!$seccion->imagen_adjunta_fondo){ ?>
	   cargar.push(1);
