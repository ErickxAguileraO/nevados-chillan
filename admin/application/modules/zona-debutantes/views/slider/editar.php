        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/zona-debutantes/slider/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/zona-debutantes/slider/eliminar_imagen/';
    var urlCargar = '/zona-debutantes/slider/cargar_imagen/';
    var urlCortar = '/zona-debutantes/slider/cortar_imagen/';
    var galeria = false;
