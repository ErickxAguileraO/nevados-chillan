        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/zona-debutantes/servicios-complementarios/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/zona-debutantes/servicios-complementarios/eliminar-imagen/';
    var urlCargar = '/zona-debutantes/servicios-complementarios/cargar-imagen/';
    var urlCortar = '/zona-debutantes/servicios-complementarios/cortar-imagen/';
	cargar_imagen();
</script> 
