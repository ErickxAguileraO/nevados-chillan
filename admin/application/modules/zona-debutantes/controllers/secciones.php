...
class Secciones extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/zona-debutantes/secciones/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/zona-debutantes/secciones/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "secc_tipo_seccion = ".$this->tipo_seccion;
        $and = " and ";
		...
		$config['base_url'] = '/zona-debutantes/secciones/';
		$config['per_page'] = 20;
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['secc_tipo_seccion'] = $this->tipo_seccion;
            ...
            #js
            $this->layout->js('/js/sistema/zona-debutantes/secciones/agregar.js');
                     #js
           $this->layout->js('/js/jquery/ckeditor-standard/ckeditor.js');
    		
    		#Nav
    		$this->layout->nav(array("Secciones" => '/zona-debutantes/secciones/', "Agregar Sección" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
           ...
           /* if($this->input->post('ruta_interna_2'))
            ...
            #registro
            if($contenido['seccion'] = $seccion = $this->ws->obtener($this->modulo,"secc_codigo = '$codigo' and secc_tipo_seccion = ".$this->tipo_seccion));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/zona-debutantes/secciones/editar.js');
            
                     #js
           $this->layout->js('/js/jquery/ckeditor-standard/ckeditor.js');
    		#Nav
    		$this->layout->nav(array("Secciones" => '/zona-debutantes/secciones/', "Editar Sección" => "/"));
