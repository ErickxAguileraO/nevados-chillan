...
class programas extends CI_Controller {
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/zona-debutantes/programas/index.js');
		...
		$config['base_url'] = '/zona-debutantes/programas/';
		$config['per_page'] = 20;
		$config['total_rows'] = count($this->ws->listar($this->modulo,"prog_tipo = 'zona-debutantes'"));
        $config['suffix'] = '/'.$url;
        ...
        $contenido["programas"] = $this->ws->listar($this->modulo,"prog_tipo = 'zona-debutantes'");
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['prog_tipo'] = 'zona-debutantes';
            ...
            #js
            $this->layout->js('/js/sistema/zona-debutantes/programas/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Programas" => '/zona-debutantes/programas/', "Agregar programas" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/zona-debutantes/programas/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("programas" => '/zona-debutantes/programas/', "Editar Sección" => "/"));
