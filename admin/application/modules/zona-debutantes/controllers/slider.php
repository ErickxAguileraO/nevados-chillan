...
class Slider extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/zona-debutantes/slider/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/zona-debutantes/slider/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "sli_tipo_seccion = 16";
        $and = " and ";
		...
		$config['base_url'] = '/zona-debutantes/slider/';
		$config['per_page'] = 20;
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/zona-debutantes/slider/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/zona-debutantes/slider/', "Agregar slider" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['slider'] = $slider = $this->ws->obtener($this->modulo,"sli_codigo = '$codigo' and sli_tipo_seccion = 16"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/zona-debutantes/slider/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/zona-debutantes/slider/', "Editar slider" => "/"));
