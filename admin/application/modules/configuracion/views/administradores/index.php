<div class="col-sm-10 text-left marg-fix">
  	...
  	<div class="subtitulo-btn">
    	<h2>&nbsp;</h2>
        <a class="btn btn-default" href="/configuracion/administradores/agregar/">Agregar administrador</a>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php if($administradores){ ?>
                <?php foreach($administradores as $aux){ ?>
                    <tr> 
						...
						<td class="text-center">
                            <a href="/configuracion/administradores/editar/<?php echo $aux->codigo; ?>/"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                        </td>
                        <td class="text-center">
