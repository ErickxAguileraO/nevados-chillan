<div class="col-sm-10 text-left marg-fix">
  	<div class="titulo-btn">
        <h1>Categorías de Promociones</h1>
    </div>
    
  	<div class="subtitulo-btn">
    	<h2>&nbsp;</h2>
        <a class="btn btn-default" href="/configuracion/categorias-promociones/agregar/">Agregar categoría</a>
    </div>
                ...
                <?php foreach($categorias as $aux){ ?>
                    <tr> 
						...
						<td class="text-center">
                            <a href="/configuracion/categorias-promociones/editar/<?php echo $aux->codigo; ?>/"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                        </td>
                        <td class="text-center">
