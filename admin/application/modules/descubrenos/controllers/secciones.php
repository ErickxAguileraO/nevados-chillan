...
class Secciones extends CI_Controller {
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/descubrenos/secciones/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "secc_tipo_seccion = 8";
        $and = " and ";
		...
		$config['base_url'] = '/descubrenos/secciones/';
		$config['per_page'] = 20;
		...
		$contenido["secciones"] = $this->ws->listar($this->modulo,$where);  //19 secciones 
	...
	public function agregar(){
        ...
        if($this->input->post()){
           ...
           $this->layout->js('/js/jquery/ckeditor-standard/ckeditor.js');
    		...
    		#Nav
    		$this->layout->nav(array("Secciones" => '/descubrenos/secciones/', "Agregar Sección" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
           ...
           /* if($this->input->post('ruta_interna_2'))
            ...
            #registro
            if($contenido['seccion'] = $seccion = $this->ws->obtener($this->modulo,"secc_codigo = '$codigo' and secc_tipo_seccion = 8"));
            else show_error('');
           ...
           $this->layout->js('/js/jquery/ckeditor-standard/ckeditor.js');
    		...
    		#Nav
    		$this->layout->nav(array("Secciones" => '/descubrenos/secciones/', "Editar Sección" => "/"));
    ...
    public function eliminar_imagen_adjunta(){
        ...
        if($codigo = $this->input->post('codigo')){
            ...
            #print_array($array_codigo); die; 
            
              
            $imagen = $this->ws->obtener($this->modulo,"secc_codigo = $array_codigo[0]");
            ...
            if($array_codigo[1] == 1){
                ...
                $this->ws->actualizar($this->modulo,array("secc_imagen_adjunta"=>""),"secc_codigo = $array_codigo[0]");
            ...
            if($array_codigo[1] == 2){
                ...
                if(file_exists($_SERVER['DOCUMENT_ROOT'].$imagen->imagen_adjunta2))
                    unlink($_SERVER['DOCUMENT_ROOT'].$imagen->imagen_adjunta2);
                
                $this->ws->actualizar($this->modulo,array("secc_imagen_adjunta2"=>""),"secc_codigo = $array_codigo[0]");
            ...
            if($array_codigo[1] == 3){
                ...
                if(file_exists($_SERVER['DOCUMENT_ROOT'].$imagen->imagen_adjunta3))
                    unlink($_SERVER['DOCUMENT_ROOT'].$imagen->imagen_adjunta3);
                
                $this->ws->actualizar($this->modulo,array("secc_imagen_adjunta3"=>""),"secc_codigo = $array_codigo[0]");
