...
class Slider extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/descubrenos/slider/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/descubrenos/slider/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "sli_tipo_seccion = 8";
        $and = " and ";
		...
		$config['base_url'] = '/descubrenos/slider/';
		$config['per_page'] = 20;
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['sli_tipo_seccion'] = 8; #indica que pertenece a descubrenos
            ...
            #js
            $this->layout->js('/js/sistema/descubrenos/slider/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/descubrenos/slider/', "Agregar slider" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['slider'] = $slider = $this->ws->obtener($this->modulo,"sli_codigo = '$codigo' and sli_tipo_seccion = 8"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/descubrenos/slider/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/descubrenos/slider/', "Editar slider" => "/"));
