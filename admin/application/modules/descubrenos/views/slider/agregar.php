        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/descubrenos/slider/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/descubrenos/slider/eliminar-imagen/';
    var urlCargar = '/descubrenos/slider/cargar-imagen/';
    var urlCortar = '/descubrenos/slider/cortar-imagen/';
	cargar_imagen();
</script> 
