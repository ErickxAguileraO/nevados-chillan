        ...
        <!--
                ...
                <div class="multi-imagen" style="margin-bottom:20px;">
                    ...
                    <div id="cont-imagenes-2">
                        <?php if($seccion->imagenes){ ?>
                            <?php foreach($seccion->imagenes as $aux){ ?>
                                <div class="box" >
                        			<div class="img" style="width:<?php echo $this->img->min_ancho_2+2; ?>px; height:<?php echo $this->img->min_alto_2+2; ?>px;" >
                                        <img class="croppedImg" src="<?php echo $aux->ruta_interna; ?>" />
                                        <div class="cropControls cropControlsUpload">
                                            <i class="cropControlRemoveCroppedImage eliminar_imagen" rel="<?php echo $aux->codigo; ?>"></i>
                                        </div>
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/descubrenos/secciones/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/descubrenos/secciones/eliminar-imagen/';
    var urlCargar = '/descubrenos/secciones/cargar-imagen/';
    var urlCortar = '/descubrenos/secciones/cortar-imagen/';
    var galeria = false;
    var cargar = [];
    <?php if(!$seccion->imagen_adjunta_fondo){ ?>
	   cargar.push(1);
