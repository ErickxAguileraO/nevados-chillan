...
class Secciones extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/valle-hermoso/secciones/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/valle-hermoso/secciones/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "secc_tipo_seccion = 3";
        $and = " and ";
		...
		$config['base_url'] = '/valle-hermoso/secciones/';
		$config['per_page'] = 20;
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/valle-hermoso/secciones/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Secciones" => '/valle-hermoso/secciones/', "Agregar Sección" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['seccion'] = $seccion = $this->ws->obtener($this->modulo,"secc_codigo = '$codigo' and secc_tipo_seccion = 3"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/valle-hermoso/secciones/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Secciones" => '/valle-hermoso/secciones/', "Editar Sección" => "/"));
