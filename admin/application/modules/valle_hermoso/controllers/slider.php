...
class Slider extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/valle-hermoso/slider/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/valle-hermoso/slider/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "sli_tipo_seccion = 3";
        $and = " and ";
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['sli_tipo_seccion'] = 3; #indica que pertenece a valle hermoso
            ...
            #js
            $this->layout->js('/js/sistema/valle-hermoso/slider/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/valle-hermoso/slider/', "Agregar slider" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['slider'] = $slider = $this->ws->obtener($this->modulo,"sli_codigo = '$codigo' and sli_tipo_seccion = 3"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/valle-hermoso/slider/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/valle-hermoso/slider/', "Editar slider" => "/"));
