        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/valle-hermoso/banners/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/valle-hermoso/banners/eliminar-imagen/';
    var urlCargar = '/valle-hermoso/banners/cargar-imagen/';
    var urlCortar = '/valle-hermoso/banners/cortar-imagen/';
    var galeria = false;
