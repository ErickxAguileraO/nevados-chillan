        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/valle-hermoso/slider/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/valle-hermoso/slider/eliminar-imagen/';
    var urlCargar = '/valle-hermoso/slider/cargar-imagen/';
    var urlCortar = '/valle-hermoso/slider/cortar-imagen/';
	cargar_imagen();
</script> 
