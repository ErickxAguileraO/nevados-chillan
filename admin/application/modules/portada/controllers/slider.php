...
class Slider extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->max_ancho_1 = 2880;
        $this->img->max_alto_1 = 2880;
 
        #define el tamaño del recorte
        $this->img->recorte_ancho_1 = 2880;
        $this->img->recorte_alto_1 = 1140;
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['sli_tipo_seccion'] = 4; #indica que pertenece a portada
    		...
    		#Nav
    		$this->layout->nav(array("Slider" => '/portada/slider/', "Agregar slider" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['slider'] = $slider = $this->ws->obtener($this->modulo,"sli_codigo = '$codigo' and sli_tipo_seccion = 4"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/portada/slider/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/portada/slider/', "Editar slider" => "/"));
