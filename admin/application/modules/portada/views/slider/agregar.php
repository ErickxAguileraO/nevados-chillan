        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/portada/slider/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/portada/slider/eliminar-imagen/';
    var urlCargar = '/portada/slider/cargar-imagen/';
    var urlCortar = '/portada/slider/cortar-imagen/';
	cargar_imagen();
</script> 
