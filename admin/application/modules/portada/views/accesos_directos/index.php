<div class="col-sm-10 text-left marg-fix">
  	...
  	<div class="subtitulo-btn">
    	<h2>&nbsp;</h2>
        <a class="btn btn-default" href="/portada/accesos-directos/agregar/">Agregar acceso directo</a>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php if($accesos){ ?>
                <?php foreach($accesos as $aux){ ?>
                    <tr> 
                        <td><?php echo $aux->titulo; ?></td>
                        <td><?php echo $aux->orden; ?></td>
                        <td><?php echo ($aux->estado)?'Activo':'Inactivo'; ?></td>
						<td class="text-center">
                            <a href="/portada/accesos-directos/editar/<?php echo $aux->codigo; ?>/"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                        </td>
                        <td class="text-center">
