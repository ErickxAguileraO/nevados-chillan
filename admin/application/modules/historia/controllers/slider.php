...
class Slider extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/historia/slider/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/historia/slider/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "sli_tipo_seccion = 15";
        $and = " and ";
		...
		$config['base_url'] = '/historia/slider/';
		$config['per_page'] = 20;
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['sli_tipo_seccion'] = 15; #indica que pertenece a historia
            ...
            #js
            $this->layout->js('/js/sistema/historia/slider/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/historia/slider/', "Agregar slider" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['slider'] = $slider = $this->ws->obtener($this->modulo,"sli_codigo = '$codigo' and sli_tipo_seccion = 15"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/historia/slider/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/historia/slider/', "Editar slider" => "/"));
