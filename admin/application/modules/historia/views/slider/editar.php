        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/historia/slider/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/historia/slider/eliminar-imagen/';
    var urlCargar = '/historia/slider/cargar-imagen/';
    var urlCortar = '/historia/slider/cortar-imagen/';
    var galeria = false;
