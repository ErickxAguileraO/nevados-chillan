...
class Promociones extends CI_Controller {
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $contenido['eventos'] = $this->ws->listar(71,"cae_estado = 1");
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            $this->ws->order("cae_orden ASC");
            $contenido['categorias'] = $this->ws->listar(71,"cae_estado = 1");
    ...
    public function eliminar() {
		try {
			...
			echo json_encode(array("result" => false, "msg" => "Ha ocurrido un error inesperado. Por favor, intentelo nuevamente."));
		}
    }
