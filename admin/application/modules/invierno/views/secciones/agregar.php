    ...
    <form action="#" method="post" id="form-agregar" >
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
        	<div class="col-md-5">
                ...
                <label>Video</label>
                <input type="url" class="form-control" name="video" id="video" value="<?php echo $seccion->video; ?>" />
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/invierno/secciones/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/invierno/secciones/eliminar-imagen/';
    var urlCargar = '/invierno/secciones/cargar-imagen/';
    var urlCortar = '/invierno/secciones/cortar-imagen/';
    var galeria = false; 
