...
class Slider extends CI_Controller {
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/invierno/slider/index.js');
		...
		$config['base_url'] = '/invierno/slider/';
		$config['per_page'] = 20;
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['sli_tipo_seccion'] = 9; #indica que pertenece a invierno
            ...
            #js
            $this->layout->js('/js/sistema/invierno/slider/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/invierno/slider/', "Agregar slider" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['slider'] = $slider = $this->ws->obtener($this->modulo,"sli_codigo = '$codigo' and sli_tipo_seccion = 9"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/invierno/slider/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/invierno/slider/', "Editar slider" => "/"));
