...
class Secciones extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/invierno/secciones/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/invierno/secciones/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "secc_tipo_seccion = 9";
        $and = " and ";
		...
		$config['base_url'] = '/invierno/secciones/';
		$config['per_page'] = 20;
