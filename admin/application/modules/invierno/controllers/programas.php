...
class programas extends CI_Controller {
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/invierno/programas/index.js');
		...
		$config['base_url'] = '/invierno/programas/';
		$config['per_page'] = 20;
		$config['total_rows'] = count($this->ws->listar($this->modulo,"prog_tipo = 'invierno'"));
        $config['suffix'] = '/'.$url;
        ...
        $contenido["programas"] = $this->ws->listar($this->modulo,"prog_tipo = 'invierno'");
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/invierno/programas/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Programas" => '/invierno/programas/', "Agregar programas" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/invierno/programas/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("programas" => '/invierno/programas/', "Editar Sección" => "/"));
