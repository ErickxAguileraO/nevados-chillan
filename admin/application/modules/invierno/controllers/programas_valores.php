...
class Programas_valores extends CI_Controller {
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/invierno/programas-valores/agregar.js');
        
        #contenido
        $contenido['programa'] = $this->ws->obtener($this->modulo,"prv_tipo_seccion = 9");
