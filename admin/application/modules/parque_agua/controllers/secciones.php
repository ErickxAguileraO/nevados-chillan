...
class Secciones extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/parque-agua/secciones/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/parque-agua/secciones/index.js');
		...
		$config['base_url'] = '/parque-agua/secciones/';
		$config['per_page'] = 20;
