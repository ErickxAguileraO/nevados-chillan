...
class Slider extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/parque-agua/slider/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/parque-agua/slider/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "sli_tipo_seccion = 2";
        $and = " and ";
		...
		$config['base_url'] = '/parque-agua/slider/';
		$config['per_page'] = 20;
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/parque-agua/slider/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/parque-agua/slider/', "Agregar slider" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['slider'] = $slider = $this->ws->obtener($this->modulo,"sli_codigo = '$codigo' and sli_tipo_seccion = 2"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/parque-agua/slider/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/parque-agua/slider/', "Editar slider" => "/"));
