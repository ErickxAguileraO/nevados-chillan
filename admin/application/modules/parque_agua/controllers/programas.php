...
class programas extends CI_Controller {
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/parque-agua/programas/index.js');
		...
		$config['base_url'] = '/parque-agua/programas/';
		$config['per_page'] = 20;
		$config['total_rows'] = count($this->ws->listar($this->modulo,"prog_tipo = 'parque-agua'"));
        $config['suffix'] = '/'.$url;
        ...
        $contenido["programas"] = $this->ws->listar($this->modulo,"prog_tipo = 'parque-agua'");
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/parque-agua/programas/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Programas" => '/parque-agua/programas/', "Agregar programas" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/parque-agua/programas/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("programas" => '/parque-agua/programas/', "Editar Sección" => "/"));
