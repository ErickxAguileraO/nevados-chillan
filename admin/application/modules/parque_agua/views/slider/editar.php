        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/parque-agua/slider/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/parque-agua/slider/eliminar-imagen/';
    var urlCargar = '/parque-agua/slider/cargar-imagen/';
    var urlCortar = '/parque-agua/slider/cortar-imagen/';
    var galeria = false;
