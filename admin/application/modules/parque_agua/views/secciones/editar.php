        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/parque-agua/secciones/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/parque-agua/secciones/eliminar-imagen/';
    var urlCargar = '/parque-agua/secciones/cargar-imagen/';
    var urlCortar = '/parque-agua/secciones/cortar-imagen/';
    var galeria = false;
    var cargar = [];
    <?php if(!$seccion->imagen_adjunta_fondo){ ?>
	   cargar.push(1);
