...
class Secciones extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/verano/secciones/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/verano/secciones/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "secc_tipo_seccion = 14";
        $and = " and ";
		...
		$config['base_url'] = '/verano/secciones/';
		$config['per_page'] = 20;
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['seccion'] = $seccion = $this->ws->obtener($this->modulo,"secc_codigo = '$codigo' and secc_tipo_seccion = 14"));
            else show_error('');
    		...
    		#Nav
    		$this->layout->nav(array("Secciones" => '/verano/secciones/', "Editar Sección" => "/"));
