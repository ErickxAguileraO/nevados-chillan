...
class Slider extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/valle-las-trancas/slider/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/valle-las-trancas/slider/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "sli_tipo_seccion = 11";
        $and = " and ";
		...
		$config['base_url'] = '/valle-las-trancas/slider/';
		$config['per_page'] = 20;
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['sli_tipo_seccion'] = 11; #indica que pertenece a valle-las-trancas
            ...
            #js
            $this->layout->js('/js/sistema/valle-las-trancas/slider/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/valle-las-trancas/slider/', "Agregar slider" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['slider'] = $slider = $this->ws->obtener($this->modulo,"sli_codigo = '$codigo' and sli_tipo_seccion = 11"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/valle-las-trancas/slider/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/valle-las-trancas/slider/', "Editar slider" => "/"));
