        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/valle-las-trancas/slider/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/valle-las-trancas/slider/eliminar-imagen/';
    var urlCargar = '/valle-las-trancas/slider/cargar-imagen/';
    var urlCortar = '/valle-las-trancas/slider/cortar-imagen/';
	cargar_imagen();
</script> 
