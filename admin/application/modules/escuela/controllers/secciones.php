...
class Secciones extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/escuela/secciones/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/escuela/secciones/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "secc_tipo_seccion = 13";
        $and = " and ";
		...
		$config['base_url'] = '/escuela/secciones/';
		$config['per_page'] = 20;
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
           ...
           /* if($this->input->post('ruta_interna_2'))
            ...
            #registro
            if($contenido['seccion'] = $seccion = $this->ws->obtener($this->modulo,"secc_codigo = '$codigo' and secc_tipo_seccion = 13"));
            else show_error('');
           ...
           $this->layout->js('/js/jquery/ckeditor-standard/ckeditor.js');
    		...
    		#Nav
    		$this->layout->nav(array("Secciones" => '/escuela/secciones/', "Editar Sección" => "/"));
