...
class programas extends CI_Controller {
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/escuela/programas/index.js');
		...
		$config['base_url'] = '/escuela/programas/';
		$config['per_page'] = 20;
		$config['total_rows'] = count($this->ws->listar($this->modulo,"prog_tipo = 'escuela'"));
        $config['suffix'] = '/'.$url;
        ...
        $contenido["programas"] = $this->ws->listar($this->modulo,"prog_tipo = 'escuela'");
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/escuela/programas/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Programas" => '/escuela/programas/', "Agregar programas" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/escuela/programas/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("programas" => '/escuela/programas/', "Editar Sección" => "/"));
