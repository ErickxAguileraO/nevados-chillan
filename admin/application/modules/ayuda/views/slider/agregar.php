        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/ayuda/slider/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/ayuda/slider/eliminar-imagen/';
    var urlCargar = '/ayuda/slider/cargar-imagen/';
    var urlCortar = '/ayuda/slider/cortar-imagen/';
	cargar_imagen();
</script> 
