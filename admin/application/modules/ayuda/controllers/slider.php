...
class Slider extends CI_Controller {
	...
	function __construct(){
        ...
        $this->img->recorte_alto_1 = 1314;
        
        $this->img->upload_dir = '/imagenes/modulos/ayuda/slider/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/ayuda/slider/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "sli_tipo_seccion = 12";
        $and = " and ";
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['sli_tipo_seccion'] = 12; #indica que pertenece a ayuda
            ...
            #js
            $this->layout->js('/js/sistema/ayuda/slider/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/ayuda/slider/', "Agregar slider" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['slider'] = $slider = $this->ws->obtener($this->modulo,"sli_codigo = '$codigo' and sli_tipo_seccion = 12"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/ayuda/slider/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Slider" => '/ayuda/slider/', "Editar slider" => "/"));
