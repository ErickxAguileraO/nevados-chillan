        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/hoteles/<?php echo $hotel->url; ?>/banners/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/hoteles/banners/eliminar-imagen/';
    var urlCargar = '/hoteles/banners/cargar-imagen/';
    var urlCortar = '/hoteles/banners/cortar-imagen/';
    var galeria = false;
