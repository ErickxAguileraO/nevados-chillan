        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/hoteles/<?php echo $hotel->url; ?>/slider/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/hoteles/slider/eliminar-imagen/';
    var urlCargar = '/hoteles/slider/cargar-imagen/';
    var urlCortar = '/hoteles/slider/cortar-imagen/';
    var galeria = false;
