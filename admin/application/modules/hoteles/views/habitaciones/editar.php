    ...
    <form action="#" method="post" id="form-editar" >
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
        	<div class="col-md-5">
                ...
                <?php if($habitacion->imagen_adjunta){ ?>
                    <img style="width: 100px;margin-top: 15px;" src="<?php echo $habitacion->imagen_adjunta; ?>" />
                    <a class="eliminar_adjunto" rel="<?php echo $habitacion->codigo;?>" style="cursor:pointer;">
                        <span class="glyphicon glyphicon-trash" aria-hidden="true"></span>
				    </a>
                <?php } ?>
                
                <label>Nombre imagen adjunta</label>
                <input type="text" class="form-control" name="nombre_imagen_adjunta" value="<?php echo $habitacion->nombre_imagen_adjunta; ?>" />
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/hoteles/<?php echo $hotel->url; ?>/habitaciones/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/hoteles/habitaciones/eliminar-imagen/';
    var urlCargar = '/hoteles/habitaciones/cargar-imagen/';
    var urlCortar = '/hoteles/habitaciones/cortar-imagen/';
    var galeria = true;
