<div class="col-sm-10 text-left marg-fix">
  	...
  	<div class="subtitulo-btn">
    	<h2>&nbsp;</h2>
        <a class="btn btn-default" href="/hoteles/<?php echo $hotel->url; ?>/habitaciones/agregar/">Agregar habitación</a>
    </div>
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php if($habitaciones){ ?>
                <?php foreach($habitaciones as $aux){ ?>
                    <tr> 
                        <td><?php echo $aux->titulo; ?></td>
                        <td><?php echo $aux->orden; ?></td>
                        <td><?php echo ($aux->estado)?'Activo':'Inactivo'; ?></td>
						<td class="text-center">
                            <a href="/hoteles/<?php echo $hotel->url; ?>/habitaciones/editar/<?php echo $aux->codigo; ?>/"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                        </td>
                        <td class="text-center">
