        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/hoteles/<?php echo $hotel->url; ?>/actividades/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/hoteles/actividades/eliminar-imagen/';
    var urlCargar = '/hoteles/actividades/cargar-imagen/';
    var urlCortar = '/hoteles/actividades/cortar-imagen/';
    var cargar = [];
    cargar.push(1);
    cargar.push(2);
