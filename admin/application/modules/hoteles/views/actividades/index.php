<div class="col-sm-10 text-left marg-fix">
  	...
  	<div class="subtitulo-btn">
    	<h2>&nbsp;</h2>
        <a class="btn btn-default" href="/hoteles/<?php echo $hotel->url; ?>/actividades/agregar/">Agregar actividad</a>
    </div>
                ...
                <?php foreach($actividades as $aux){ ?>
                    <tr> 
						...
						<td class="text-center">
                            <a href="/hoteles/<?php echo $hotel->url; ?>/actividades/editar/<?php echo $aux->codigo; ?>/"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                        </td>
                        <td class="text-center">
