...
class Banners extends CI_Controller {
	...
	private $modulo = 21,$modulo_hotel = 14;
    public $img;
	...
	function __construct(){
        ...
        $this->img->upload_dir = '/imagenes/modulos/hoteles/banners/';
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/hoteles/banners/index.js');
        
        $where = $and = "";
        $url = "";
        
        $where = "ban_hotel = '$hotel->codigo' and ban_tipo_seccion = 1";
        $and = " and ";
		...
		$config['base_url'] = '/hoteles/'.$hotel->url.'/banners/';
		$config['per_page'] = 20;
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['ban_hotel'] = $hotel->codigo;
            $datos['ban_tipo_seccion'] = 1;
            ...
            #js
            $this->layout->js('/js/sistema/hoteles/banners/agregar.js');
    		
    		#Nav
    		$this->layout->nav(array("Banners" => '/hoteles/'.$hotel->url.'/banners/', "Agregar Banner" => "/"));
    		
    		#view
    		$this->layout->view('banners/agregar',$contenido);
        }
	}
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #registro
            if($contenido['banner'] = $banner = $this->ws->obtener($this->modulo,"ban_codigo = '$codigo' and ban_hotel = '$hotel->codigo' and ban_tipo_seccion = 1"));
            else show_error('');
            ...
            #js
            $this->layout->js('/js/sistema/hoteles/banners/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("Banners" => '/hoteles/'.$hotel->url.'/banners/', "Editar Banner" => "/"));
