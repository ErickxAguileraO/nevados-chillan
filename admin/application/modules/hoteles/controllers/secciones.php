...
class Secciones extends CI_Controller {
	...
	public function index(){
        ...
        $where = "secc_hotel = '$hotel->codigo' and secc_tipo_seccion = 1";
        $and = " and ";
		...
		$config['base_url'] = '/hoteles/'.$hotel->url.'/secciones/';
		$config['per_page'] = 20;
	...
	public function agregar(){
        ...
        if($this->input->post()){
    		...
    		#view
    		$this->layout->view('secciones/agregar',$contenido);
        }
	}
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
    		...
    		#Nav
    		$this->layout->nav(array("Secciones" => '/hoteles/'.$hotel->url.'/secciones/', "Editar Sección" => "/"));
