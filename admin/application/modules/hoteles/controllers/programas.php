...
class programas extends CI_Controller {
   ...
   private $modulo_hotel = 14;
	...
	public function index(){
        ...
        #js
        $this->layout->js('/js/sistema/hoteles/programas/index.js');
		...
		$config['base_url'] = '/hoteles/'.$hotel->url.'/programas/'; 
		$config['per_page'] = 20;
		$config['total_rows'] = count($this->ws->listar($this->modulo,"prog_tipo = '$hotel->url'"));
        $config['suffix'] = '/'.$url;
        ...
        $contenido["programas"] = $this->ws->listar($this->modulo, "prog_tipo = '$hotel->url'");
	...
	public function agregar(){
        ...
        if($this->input->post()){
            ...
            $datos['prog_tipo'] =  $this->input->post("tipo");
            ...
            $url_final = "/hoteles/".$this->input->post("tipo")."/programas/";

            echo json_encode(array("result"=>true, "url" => $url_final ));
            ...
            #js
            $this->layout->js('/js/sistema/hoteles/programas/agregar.js');
    		...
    		#Nav
    		$this->layout->nav(array("Programas" => '/hoteles/programas/', "Agregar programas" => "/"));
    ...
    public function editar($codigo){
        ...
        if($this->input->post()){
            ...
            #js
            $this->layout->js('/js/sistema/hoteles/programas/editar.js');
    		
    		#Nav
    		$this->layout->nav(array("programas" => '/hoteles/programas/', "Editar Sección" => "/"));
