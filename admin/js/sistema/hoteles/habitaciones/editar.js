$(document).ready(function () {
    ...
    $("#form-editar").validationEngine('attach', {
        ...
        onValidationComplete: function (form, status) {
			if (status) {
        		...
        		$.ajax({
        			url: '/hoteles/'+$("#url_hotel").val()+'/habitaciones/editar/'+$("#codigo").val()+'/',
        			type: 'post',
        			dataType: 'html',
        			data: formData,
                    cache: false,
        			...
        			success: function (result) {
        				...
        				if(json.result){
        					...
        					setTimeout(function () {
        						window.location.href = '/hoteles/'+$("#url_hotel").val()+'/habitaciones/';
        					}, 1000);
        				}else{
    ...
    $(".eliminar_adjunto").click(function(){
        ...
        if(codigo){
            $.ajax({
        		url: '/hoteles/habitaciones/eliminar-imagen-adjunta/',
        		type: 'post',
        		dataType: 'json',
        		data: 'codigo='+codigo,
        		success: function (result) {}
