$(document).ready(function () {
    ...
    $("#form-editar").validationEngine('attach', {
        ...
        onValidationComplete: function (form, status) {
			if (status) {
        		...
        		$.ajax({
        			url: '/ayuda/condiciones-reglamentos/editar/'+$("#codigo").val()+'/',
        			type: 'post',
        			dataType: 'html',
        			data: formData,
                    cache: false,
        			...
        			success: function (result) {
        				...
        				if(json.result){
        					...
        					setTimeout(function () {
        						window.location.href = '/ayuda/condiciones-reglamentos/';
        					}, 1000);
        				}else{
    ...
    $("html").on('click','.eliminar_archivo',function(){
        ...
        $.ajax({
			url: '/ayuda/condiciones-reglamentos/eliminar-archivo/',
			type: 'post',
			dataType: 'json',
			data: 'codigo='+codigo,
			success: function (result) {
