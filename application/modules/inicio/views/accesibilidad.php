...
<div class="chrome">
  <p class="text-sub-titulo">Chrome</p>
  <p>Mantenga pulsada la tecla <strong>Alt</strong> y presione el número de la <strong>tecla de acceso</strong>.</p>
</div>
...
<div class="editable">
  <ul>
    <li>Alt + 0 -> Inicio</li>
    <li>Alt + 1 -> Quiénes somos</li>
    <li>Alt + 2 -> Noticias</li>
    <li>Alt + 3 -> Productos</li>
    <li>Alt + 4 -> Documentos</li>
    <li>Alt + 5 -> Servicios</li>
    <li>Alt + 6 -> Contáctenos</li>
  </ul>
</div>
<p>Puede encontrar más información sobre las teclas de acceso en <a onclick="this.target='_blank'" onkeypress="this.target='_blank'" href="https://www.discapnet.es/web_accesible/wcag10/WAI-WEBCONTENT-19990505_es.html">Directrices de  Accesibilidad del W3C.</a></p>
