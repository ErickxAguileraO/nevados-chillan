...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family: 'Open Sans', sans-serif;">
  <tr>
    <td><div style="width:720px; margin:0 auto;">
        <h1 style="font-size:24px; color:#333; margin-bottom:30px;">Formulario de contacto</h1>
        ...
        <table border="0" cellpadding="10" cellspacing="0" style="font-size:15px; margin:0 0 40px;">
          <tbody>
            <tr bgcolor="#f0f0f0">
              ...
              <td bgcolor="#f0f0f0" style="color: #333; font-size: 15px;"><?php echo $con_nombre_completo; ?></td>
            </tr>
            <tr>
              <td bgcolor="#f0f0f0" style="color:#666; font-size:15px;">Correo Electronico:</td>
              <td bgcolor="#f0f0f0" style="color: #333; font-size: 15px;"><?php echo $con_email; ?></td>
            </tr>
            <tr>
              <td bgcolor="#f0f0f0" style="color:#666; font-size:15px;">Teléfono:</td>
              <td bgcolor="#f0f0f0" style="color: #333; font-size: 15px;"><?php echo $con_telefono; ?></td>
            </tr>
            <tr>
              <td bgcolor="#f0f0f0" style="color:#666; font-size:15px;">Asunto:</td>
            ...
            <tr>
              ...
              <td bgcolor="#f0f0f0" style="color: #333; font-size: 15px;"><?php echo invierte_fecha($con_fecha,'-'); ?></td>
            </tr>
            <tr>
              <td bgcolor="#f0f0f0" style="color:#666; font-size:15px;">Hora:</td>
              <td bgcolor="#f0f0f0" style="color: #333; font-size: 15px;"><?php echo $con_hora; ?></td>
            </tr>
            <tr>
              <td bgcolor="#f0f0f0" style="color:#666; font-size:15px;">Comentario:</td>
              <td bgcolor="#f0f0f0" style="color: #333; font-size: 15px;"><?php echo $con_mensaje; ?></td>
            </tr>
